...
<div role="article" aria-roledescription="email" aria-label="Confirm your email address" lang="en">
    <table style="height: 100vh; width: 100%; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
            <td align="center" style="background-color: #eff6ff;">
                                ...
                                <tr style="margin: 5px; display: block; border-radius: 8px; background-color: #93c5fd; padding: 5px;">
                                    <td class="sm-px-24" style="border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-size: 16px; line-height: 24px; color: #1f2937;">
                                        ...
                                        <p style="margin: 0; margin-bottom: 24px;">
                                            {{ $sender['name'] }} has share a value prop with you,
                                            please click on the button below to view and edit this value proposition,
                                        </p>
                                        <p style="color: #6b7280;">
                                            password:
                                            <span style="font-weight: 600; color: #4b5563;">{{ $password }}</span>
                                            <span style="color: #93c5fd;">
                          <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="height: 20px; width: 20px;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                        </span>
                                        </p>
                                        <div style="line-height: 100%;">
                                            <a href="{{ $loginUrl }}" class="hover-bg-blue-500" style="display: inline-block; background-color: #60a5fa; padding-top: 16px; padding-bottom: 16px; padding-left: 24px; padding-right: 24px; text-align: center; font-size: 16px; font-weight: 600; color: #ffffff; text-decoration: none;">
                                                <!--[if mso]><i style="letter-spacing: 24px; mso-font-width: -100%; mso-text-raise:30px;">&#8202;</i><![endif]-->
                                                <span style="mso-text-raise: 16px;">View Now</span>
                                        ...
                                        <p style="margin: 0; margin-bottom: 16px;">If the above button does not work, please <a href="https://example.com" style="color: #60a5fa; text-decoration: none;">click here</a></p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding-left: 24px; padding-right: 24px; text-align: center; font-size: 12px; color: #4b5563;">
                                        <p style="margin: 0; margin-bottom: 4px;">If you have any questions, please contact
                                            <a target="_blank" href="support@decisionlink.com" style="font-weight: 600; color: #3b82f6; text-decoration: none;">support@decisionlink.com</a></p>
                                        <p style="margin: 0;"><span style="margin-right: 6px;">2021</span> Decision Link</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
